...
"""hand = [['Diamonds', 10], ['Clubs', 6], ['Spades', 3], ['Spades', 12], ['Diamonds', 5], ['Hearts', 11], ['Spades', 4], ['Diamonds', 11], ['Spades', 11], ['Spades', 2]]
for cardh in hand:
    deck.remove(cardh)"""
...
while 1:
    ...
    if left_sum + dual_sum >= 10:
        ...
        if lowest_sum < left_sum + dual_sum:
            ...
            print(new_hand)
            new_configs = configure(new_hand)
